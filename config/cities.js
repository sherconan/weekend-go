...
const CITIES = [
  ...
  },
  {
    ...
    emoji: '🐼',
    color: '#795548',
    origin: { lat: 30.7065, lng: 104.0714 }, // 成都站
    maxRange: 500,
    badge: '🐼 成都周边游 · 2026 春季版',
    desc: '从成都出发，熊猫、火锅、川西雪山，懒人与极客都合适。',
    hotWords: ['宽窄巷子', '春熙路', '锦里', '大熊猫基地', '都江堰', '青城山', '九寨沟', '峨眉山'],
    hasLegends: true
  },
  {
    key: 'hangzhou',
    ...
    emoji: '🍵',
    color: '#009688',
    origin: { lat: 30.2741, lng: 120.1551 }, // 杭州东站
    maxRange: 500,
    badge: '🍵 杭州周边游 · 2026 春季版',
    desc: '从杭州出发，西湖、龙井、南宋临安、江南水乡全包。',
    hotWords: ['西湖', '灵隐寺', '龙井茶田', '宋城', '西溪湿地', '千岛湖', '乌镇', '南宋御街'],
    hasLegends: true
  },
  {
    key: 'chongqing',
    ...
    emoji: '🌶️',
    color: '#D84315',
    origin: { lat: 29.5630, lng: 106.5516 }, // 渝中解放碑一带
    maxRange: 500,
    badge: '🌶️ 重庆周边游 · 2026 春季版',
    desc: '从重庆出发，魔幻 8D 山城 × 两江索道 × 武隆喀斯特 × 麻辣江湖菜。',
    hotWords: ['洪崖洞', '解放碑', '长江索道', '李子坝', '磁器口', '大足石刻', '武隆天生三桥', '仙女山'],
    hasLegends: true
  },
  {
    key: 'enshi',
    ...
    emoji: '🏞',
    color: '#2E7D32',
    origin: { lat: 30.2720, lng: 109.4880 }, // 恩施州府
    maxRange: 500,
    badge: '🏞 恩施周边游 · 2026 春季版',
    desc: '从恩施出发，大峡谷 × 腾龙洞 × 清江画廊 × 土家吊脚楼，鄂西湘西川东交界的秘境折扇面。',
    hotWords: ['恩施大峡谷', '腾龙洞', '土司城', '清江画廊', '利川苏马荡', '鹿院坪', '女儿城', '屏山大峡谷'],
    hasLegends: true
  }
];
